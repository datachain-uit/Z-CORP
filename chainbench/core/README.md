...
| Binding loader | `core/workload.js`, `core/index.js`, `core/sources.js` | Selects the workload and campaign (`CHAINBENCH_WORKLOAD`, `CHAINBENCH_CAMPAIGN`), resolves workload modules and scripts, and lists source hashes. |
