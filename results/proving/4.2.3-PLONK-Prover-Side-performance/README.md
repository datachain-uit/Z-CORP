...
> These PLONK measurements (three machines) were taken before the selector-booleanity correction of `circuits/CredentialVerifier.circom` (commit `2524431`, P4a). They are kept unchanged as historical evidence. First commits,
